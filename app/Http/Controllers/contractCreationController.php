...
//ihiwalay ung pangpdc sa cash. ung pdc, rent at cusa lang
              ...
              {
                $date_issued = date("Y-m-d", strtotime(date("Y-m-d",strtotime($current_contract->date_of_billing)) . " + $x year"));
                $date_issued = date("Y-m-d", strtotime(date("Y-m-d",strtotime($current_contract->date_of_billing)) . " + $y month"));
              }
