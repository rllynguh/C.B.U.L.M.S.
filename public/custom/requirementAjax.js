 ...
 var table = $('#myTable').DataTable({
  ...
  function changeLabel()
  {
   ...
   if($("#btnSave").val()=="Save")
   {
    ...
    label=' <h1 id="label" class="modal-title align-center p-b-15">NEW REQUIREMENT<a href="javascript:void(0);" class="pull-right" data-dismiss="modal"><i class="mdi-navigation-close"></i></a></h1>';
  }    
