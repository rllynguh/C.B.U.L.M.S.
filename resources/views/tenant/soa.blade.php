			...
			<div class="row">
				<div class="col-sm-6 col-md-8">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#about" data-toggle="tab"><i class="fa fa-chain-broken"></i> Past Transactions</a></li>
						<li><a href="#mission" data-toggle="tab"><i class="fa fa-th-large"></i> Breakdown of Bills</a></li>
						<li><a href="#community" data-toggle="tab"><i class="fa fa-eye"></i> Past Bills</a></li>
					</ul>
