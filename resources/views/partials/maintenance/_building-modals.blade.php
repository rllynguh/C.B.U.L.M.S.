...
<!--MODAL-->
<!-- Parking area modal -->
<div class="modal fade" id="parkAreaCreateModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-col-green">
      {{ Form::open([
      'id' => 'parkAreaCreateForm', 'class' => 'form-horizontal'
      ])
      }}
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="form-group p-l-30">
          <div class="form-line">
            ...
            {{ Form::text('parkAreaBuilding',null,[
            'id'=> 'parkAreaBuilding',
            'readonly' => 'readonly',
            'required' => 'required',
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-lg bg-brown waves-effect waves-white col-md-12" id="btnParkAreaSubmit" value="add"><i class="mdi-content-save"></i><span> SAVE</span></button>
