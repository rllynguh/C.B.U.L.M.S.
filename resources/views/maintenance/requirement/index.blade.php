...
<ol class="breadcrumb breadcrumb-col-brown">
  ...
  <li><a href="{{route('users.index')}}"> Requirements</a></li>
</ol>
@endsection
@section('content')
<!--Delete MODAL-->
        ...
        <div class="form-group p-l-30">
          <div class="form-line">
            {{Form::text('txtDesc',null,[
              ...
              'placeholder' => 'Ex. Architectural Layout' 
              ])
            }}
          </div>
        </div>
...
<table class="table table-hover dataTable" id="myTable">
  <thead>
    <tr>
      <th class="align-center">Requirement</th>
...
@endsection
@section('scripts')
{!!Html::script("custom/requirementAjax.js")!!}
<script type="text/javascript">
  var dataurl="{!!route('requirements.getData')!!}" ;
  var url="{!!route('requirements.index')!!}" ;
</script>
@endsection
